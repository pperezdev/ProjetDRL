...
if platform.system() == "Windows":
    SECRET_ENVS_DYN_LIB_PATHS = f"{this_file_path}/../secret_envs_dynamic_libs/drl_mystery_envs_wrapper.dll"
elif platform.system() == "Darwin":
    SECRET_ENVS_DYN_LIB_PATHS = f"{this_file_path}/../secret_envs_dynamic_libs/libdrl_mystery_envs_wrapper.dylib"
elif platform.system() == "Linux":
    SECRET_ENVS_DYN_LIB_PATHS = f"{this_file_path}/../secret_envs_dynamic_libs/libdrl_mystery_envs_wrapper.so"
else:
